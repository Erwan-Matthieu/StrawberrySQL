...
public class TableGenerator {
    ...
    public static String generateTable(List<String> headersList, List<List<String>> rowList, int... overRiddenHeaderHeight) {
        StringBuilder stringBuilder = new StringBuilder();
        
        int rowHeight = overRiddenHeaderHeight.length > 0 ? overRiddenHeaderHeight[0] : 1;

        Map<Integer,Integer> columnMaxWidthMapping = getMaximumWidthofTable(headersList, rowList);
